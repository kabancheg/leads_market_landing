...
const AboutArea = () => {
  ...
  React.useEffect(() => {
    const getAboutUs = async () => {
      const response = await axios.get(`${baseApiUrl}/api/about-us?populate=*`);
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-md-12">
                ...
                >
                  <img
                    src={aboutUs.data.attributes.image.data.attributes.url}
                    alt={
                      aboutUs.data.attributes.image.data.attributes
                        .alternativeText
                    }
                  />
                </div>
              ...
              <div className="col-lg-6 col-md-12">
                ...
                >
                  ...
                  <ul className="about-list">
                    {aboutUs.data.attributes.aboutList.map((list) => (
                      <li key={list.id}>
                        <div className="icon">
