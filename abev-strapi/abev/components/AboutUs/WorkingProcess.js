            ...
            <div className="row">
              <div className="col-lg-6 col-md-12">
                <div className="working-process-content">
                  <span className="sub-title">
                    {workingProcess.data.attributes.subTitle}
                  </span>
                  <h2>{workingProcess.data.attributes.title}</h2>
                  <ul className="working-process-list">
                    {workingProcess.data.attributes.processList.map((list) => (
                      <li
                        data-aos="fade-up"
              ...
              <div className="col-lg-6 col-md-12">
                ...
                >
                  <img
                    src={
                      workingProcess.data.attributes.image.data.attributes.url
                    }
                    alt="working-process"
                  />
                </div>
